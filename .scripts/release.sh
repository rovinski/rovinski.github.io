...
cp -r \
  $(find . \
    ...
    -mindepth 1 \
    -maxdepth 1) \
  _zip/hydejack-pro-8.0.0-beta.0/install
...
# Genrate git diffs
# TODO
# git diff pro/v8.0.0-beta.0 pro/v7.5.1 > v8.0.0-beta.0-to-v7.5.1.diff

# Generate the zip
cd _zip; zip -q -r hydejack-pro-8.0.0-beta.0.zip hydejack-pro-8.0.0-beta.0/
