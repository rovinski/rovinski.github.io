...
const SHELL_CACHE = "shell-8.5.0-beta.1--v{{ cv }}--sw{{ '/' | relative_url }}";
...
const SHELL_FILES = [
  ...
  "{{ '/assets/js/hydejack-8.5.0-beta.1.js' | relative_url }}",
  "{{ '/assets/css/hydejack-8.5.0-beta.1.css' | relative_url }}",
