...
const SHELL_CACHE = "shell-8.5.0-beta.0--v{{ cv }}--sw{{ '/' | relative_url }}";
...
const SHELL_FILES = [
  ...
  "{{ '/assets/js/hydejack-8.5.0-beta.0.js' | relative_url }}",
  "{{ '/assets/css/hydejack-8.5.0-beta.0.css' | relative_url }}",
